...
class Stepper extends Component{
  render(){
    return(
          <div className="pag">
          <button className="step-button" onClick={this.props.minStep}>Previous</button>
          <span className="step-span" ><span className="page">{this.props.steps}</span>/7</span>
          <button className="step-button" onClick={this.props.addStep}>Next</button>
          </div>
